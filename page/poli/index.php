...
<div class="content-header">
    <div class="container-fluid">
        ...
        <!-- Baris untuk tombol tambah poli -->
        <div class="row">
            <div class="col-12">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="page/poli/tambah_poli.php" method="post">
                                    ...
                                    <tr>
                                        ...
                                        <div class="modal fade" id="editModal<?php echo $data['id'] ?>" tabindex="-1"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="addModalLabel">Ubah Data Poli</h5>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form action="page/poli/update_poli.php" method="post">
                                        ...
                                        <div class="modal fade" id="hapusModal<?php echo $data['id'] ?>" tabindex="-1"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="addModalLabel">Hapus Poli</h5>
                                                        <button type="button" class="close" data-dismiss="modal"
                                                            aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    ...
                                                    <div class="modal-body">
                                                        <!-- Form edit data Poli disini -->
                                                        <form action="page/poli/hapus_poli.php" method="post">
                                                            <input type="hidden" class="form-control" id="id" name="id"
                                                                value="<?php echo $data['id'] ?>" required>
                                                            <p>Anda yakin menghapus data poli ini?
                                                            </p>
