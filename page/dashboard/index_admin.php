...
include 'koneksi.php';
//kueri untuk menghitung jumlh yg terdaftar dalam tabel
...
// Eksekusi query dan ambil hasilnya seperti $result_pasien, dll
...
if ($result_pasien && $result_dokter && $result_poli && $result_obat) {
    // Ambil hasil query dan disimpan dalam variabel
    ...
    // Ambil nilai jumlah dari hasil query dalam bentuk var
    ...
    // Handle kesalahan jika query tidak berhasil koneksi database gagal
    $jumlah_pasien = "Error";
    $jumlah_dokter = "Error";
    $jumlah_poli = "Error";
    $jumlah_obat = "Error";
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="dashboard_admin.php?page=home">Home</a></li>
